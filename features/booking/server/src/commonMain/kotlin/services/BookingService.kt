 ...
 *    no booker identity, only the boolean [BookingState]. [myPresents] returns the CALLER's own
...
class BookingService(
     ...
     * Items whose backing wishlist item no longer exists are skipped.
     *
     ...
     */
    suspend fun myPresents(callerId: UserId): List<RegisteredWishlistItem> =
