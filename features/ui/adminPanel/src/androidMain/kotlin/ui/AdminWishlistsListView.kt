...
/** Android Compose-Material3 view for the admin wishlists list screen. */
    ...
    override fun onDraw() {
        ...
        Column(modifier = Modifier.fillMaxSize().padding(16.dp)) {
            Row(
                ...
                Text(AdminPanelStrings.wishlistsListTitle.translation(resources), style = MaterialTheme.typography.headlineMedium)
                Button(onClick = { viewModel.onCreateWishlist() }) {
                    Text(AdminPanelStrings.addWishlistButton.translation(resources))
                }
            }
            ...
            if (loading) {
                ...
                Text(AdminPanelStrings.emptyWishlists.translation(resources))
            } else {
                    ...
                    items(wishlists) { wishlist ->
                        Card(modifier = Modifier.fillMaxWidth()) {
                            Row(
                                ...
                                Text(wishlist.title)
                                Text("user #${wishlist.userId.long}", color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.5f))
                            }
                        }
                    }
                }
