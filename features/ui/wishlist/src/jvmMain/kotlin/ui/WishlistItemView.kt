...
class WishlistItemView(
    ...
    override fun onDraw() {
        ...
        Column(
            ...
            when {
                loading -> Text(WishlistStrings.loading.translation())
                item != null -> {
                val it = item!!
                ...
                if (it.links.isEmpty()) {
                    ...
                    it.links.forEach { link ->
                        Text(link.displayText, style = MaterialTheme.typography.body2)
                    }
                }
                ...
                if (it.imageIds.isEmpty()) {
                    WishlistItemImagePlaceholder(
                        ...
                        contentDescription = WishlistStrings.itemImagePlaceholderAlt.translation()
                    )
                } else {
                    Row(
