...
/** JVM Compose-Desktop view for the server URL editor screen. */
class ServerUrlView(
    ...
    override fun onDraw() {
        ...
        Column(
            ...
            Text(ServerUrlStrings.title.translation(), style = MaterialTheme.typography.h5)
            OutlinedTextField(
                value = url,
                onValueChange = { viewModel.onUrlChanged(it) },
                placeholder = { Text(ServerUrlStrings.urlPlaceholder.translation()) },
                singleLine = true,
                enabled = !loading,
            ...
            Button(
                ...
                Text(ServerUrlStrings.saveButton.translation())
            }
        }
    }
}
