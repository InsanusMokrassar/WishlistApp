 ...
 *
 * Composes the existing wishlist and booking UI models so the sidebar never talks to feature
 * clients directly. The concrete implementation is registered in this feature's [dev.inmo.wishlist.features.ui.sidebar.Plugin].
 */
