...
* Role will go from step to step in `agents/task/<TASK_ID_FORMAT>/<STEP_NUMBER_FORMAT>.md` and check that each one making decision based on previous steps or the prompt if it is the first step
