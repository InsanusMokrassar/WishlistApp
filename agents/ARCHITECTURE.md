...
1. Read Planning, applicable repository instructions, source, configuration, documentation and relevant task history directly. Collect required research before freezing the common brief; record sources and ask root to relay unresolved operator questions. Identify the repository revision and relevant evidence paths, feature Operator Notes and constraints in the brief. Participants may inspect repository and task-history evidence themselves; no separate council project-context file is required. Do not send ordinary root-role instructions as participant instructions.
