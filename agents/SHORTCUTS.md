...
2. Task-specific:
    ...
    * planning → `agents/PLAN.md` + (`agents/local.PLAN.md` (if exists)) (priorities of agents: `opus` / `sonnet`)
    * coding → `agents/CODING.md` + (`agents/local.CODING.md` (if exists)) (priorities of agents: `sonnet` / `opus`)
